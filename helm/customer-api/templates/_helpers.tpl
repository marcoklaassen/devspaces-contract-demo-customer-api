...
{{/*
Generate or retrieve PostgreSQL password
This function will:
1. Check if a password is explicitly provided in values
2. If not, check if the secret already exists and reuse its password
3. If secret doesn't exist, generate a new random password
*/}}
{{- define "customer-api.postgresqlPassword" -}}
...
{{- if $existingSecret }}
{{- $existingPassword := index $existingSecret.data "postgres-password" | b64dec }}
{{- $existingPassword }}
{{- else }}
{{- randAlphaNum 32 }}
{{- end }}
